...
export const userSubCriteriaGetDto = (
  userSubCriteria: UserSubCriteria
): UserSubCriteriaDto => ({
  criteria:
    userSubCriteria?.criteria && criteriaGetDto(userSubCriteria.criteria),
  ...
  subCriteria:
    userSubCriteria?.subCriteria &&
    subCriteriaGetDto(userSubCriteria.subCriteria),
